              ...
              <ul className='d-flex newInfo'>
                <li className='p-2 bd-highlight'>
                  <ul className='d-flex flex-column col01'>
                    <li><strong><Link to="#">새로운 소식</Link></strong></li>
                    <li><strong><Link to="#">멤버가입</Link></strong></li>
                    <li><strong><Link to="#">매장안내</Link></strong></li>
                    <li><strong><Link to="#">나이키 저널</Link></strong></li>
                  </ul>
                </li>
                <li className='p-2 bd-highlight'>
                  <ul className='d-flex flex-column col01'>
                    <li><strong><Link to="#">도움말</Link></strong></li>
                    <li><Link to="#">로그인 안내</Link></li>
                    <li><Link to="#">주문배송조회</Link></li>
                    <li><Link to="#">반품 정책</Link></li>
                    <li><Link to="#">결제 방법</Link></li>
                ...
                <li className='p-2 bd-highlight'>
                  <ul className='d-flex flex-column col01'>
                    <li><strong><Link to="#">ABOUT NIKE</Link></strong></li>
                    <li><Link to="#">소식</Link></li>
                    <li><Link to="#">채용</Link></li>
                    <li><Link to="#">투자자</Link></li>
              ...
              <ul className='d-flex justify-content-between'>
                ...
                <li>
                  <ul className='d-flex flex-row info02'>
                    ...
                    <li><strong><Link to="#">개인정보처리방침</Link></strong></li>
                    <li><Link to="#">위치 기반 서비스 약관</Link></li>
                    <li><Link to="#">영상정보처리기기 운영 방침</Link></li>
                  </ul>
                </li>
              </ul>
            </div>
              ...
              <ul className='d-flex flex-row mb-2 callGroup'>
                <li className=''>
                  <ul className='d-flex flex-column justify-content-start'>
                    <li className=''>(유)나이키코리아 대표 Kimberlee Lynn Chang Mendes, 킴벌리 린 창 멘데스 | 서울 강남구 테헤란로 152 강남파이낸스센터 30층 |&nbsp;
                      <strong>사업자 정보 확인</strong></li>
                    <li className=''>
                ...
                <li>
                  <ul className='d-flex flex-column mb-2'>
                    <li>현금 등으로 결제 시 안전 거래를 위해 나이키 쇼핑몰에서 가입하신 한국결제네트웍스 유한회사의 구매안전 서비스(<strong>결제대금예치</strong>)</li>
